      ...
      <main className="max-w-4xl mx-auto px-4 py-8 w-full overflow-hidden">
        ...
        <article className="bg-black/40 p-6 md:p-10 rounded-2xl border border-gray-800 shadow-xl leading-loose w-full">
            ...
            <h3 className="text-lg md:text-xl font-prompt font-bold mt-8 mb-4 text-ezgold-300 flex items-center gap-2">
                <Trophy className="w-5 h-5 md:w-6 md:h-6" /> กติกาและมูลค่าเงินรางวัลสลากกินแบ่งรัฐบาล (อ้างอิงกองสลากฯ)
            </h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-8">
                <div className="w-full">
                    <img src="/ezlotto-howto.gif" alt="วิธีแทงหวยออนไลน์ EZLOTTO" className="w-full max-w-[400px] mx-auto rounded-xl border-2 border-ezgold-500/50 shadow-lg" />
                </div>
                <div className="w-full">
            ...
            <h4 className="font-bold text-white text-base md:text-lg mb-3">📱 วิธีการพิมพ์แทงหวยในระบบ EZLOTTO</h4>
            <p className="text-xs md:text-sm text-gray-300 mb-4">ระบบของเราออกแบบมาให้ใช้งานง่ายผ่านแชท หรือระบบออโต้ รูปแบบการพิมพ์ที่ถูกต้องคือ <code>[เลขที่ต้องการแทง] [รูปแบบ] = [จำนวนเงิน]</code> เช่น:</p>
        ...
        <div className="mt-10 text-center w-full">
            <img src="/ezlotto-promo.gif" alt="โปรโมชั่น EZLOTTO" className="max-w-[250px] md:max-w-[300px] w-full mx-auto rounded-xl border-2 border-ezgold-500 shadow-[0_0_20px_rgba(212,175,55,0.5)] mb-6" />
